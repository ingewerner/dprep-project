...
To see the nature of the tweets we can make a sentiment analysis. We do that for both years again and see that in 2020 the negativity and positivity scores the highest. In 2021 we however see that the difference in sentiment scores is a bit bigger now: it's more negative. That's a noticable difference!
